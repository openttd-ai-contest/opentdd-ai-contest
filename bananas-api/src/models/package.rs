...
pub struct Package {
    ...
    pub replaced_by: Option<Box<crate::models::PackageAllOfReplacedBy>>,
    #[serde(rename = "authors", skip_serializing_if = "Option::is_none")]
    pub authors: Option<Vec<crate::models::Author>>,
    #[serde(rename = "versions", skip_serializing_if = "Option::is_none")]
    pub versions: Option<Vec<crate::models::VersionMinimized>>,
}

impl Package {
    pub fn new(content_type: crate::models::ContentType, unique_id: String) -> Package {
        Package {
            name: None,
            description: None,
            url: None,
