...
pub struct NewPackageUploadTokenPutRequest {
    ...
    pub license: Option<Option<serde_json::Value>>,
    ...
    pub content_type: Option<models::ContentType>,
    #[serde(rename = "unique-id", skip_serializing_if = "Option::is_none")]
    pub unique_id: Option<String>,
}

impl NewPackageUploadTokenPutRequest {
    pub fn new(upload_date: String) -> NewPackageUploadTokenPutRequest {
